...
insert into EPREUVE(dateDebutValidite, dateFinValidite, etat, idTest) values ('2018-10-08 10:00:00', '2020-10-08 10:00:00', 'EA', 1);
insert into EPREUVE(dateDebutValidite, dateFinValidite, etat, idTest) values ('2018-11-04 08:00:00', '2020-11-08 10:00:00', 'EA', 2);

insert into EPREUVE_UTILISATEUR(idEpreuve, idUtilisateur) values (1, 1);
insert into EPREUVE_UTILISATEUR(idEpreuve, idUtilisateur) values (2, 1);
