...
insert into EPREUVE(dateDebutValidite, dateFinValidite, etat, idTest, idUtilisateur) values ('2018-10-08 10:00:00', '2020-10-08 10:00:00', 'EA', 1, 2);
insert into EPREUVE(dateDebutValidite, dateFinValidite, etat, idTest, idUtilisateur) values ('2018-11-04 08:00:00', '2020-11-08 10:00:00', 'EA', 2, 2);
insert into EPREUVE(dateDebutValidite, dateFinValidite, etat, idTest, idUtilisateur) values ('2018-09-04 10:30:00', '2020-09-04 20:30:00', 'EA', 3, 2);
...
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('ServletRequest', 0, 2);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('HttpServlet', 1, 2);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('Servlet', 0, 2);
insert into QUESTION(enonce, points, idTheme) values ('Quelle méthode permet une lecture de paramètre? : ', 1, 2);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('setParameter(String name)', 0, 3);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('getParameter(String name)', 1, 3);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('parameter(String name)', 0, 3);
insert into QUESTION(enonce, points, idTheme) values ('Quelle méthode permet de renvoyer un message d''erreur? : ', 1, 2);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('error(...)', 0, 4);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('setError(...)', 0, 4);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('sendError(...)', 1, 4);

insert into QUESTION(enonce, points, idTheme) values ('Que signifie PHP? : ', 1, 3);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('Hypertext Preprocessor', 1, 5);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('Personal Home Page', 0, 5);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('Personal Home Page', 0, 5);
insert into QUESTION(enonce, points, idTheme) values ('Quels sont les délimiteurs du langage PHP  ? : ', 1, 3);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('<? ... ?>', 0, 6);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('<?php ... ?>', 1, 6);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('<% %>', 0, 6);
...
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('fonction bonjour{} ;', 0, 7);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('fonction bonjour(){} ;', 0, 7);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('function bonjour(){}.', 1, 7);
...
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('echo ;', 1, 8);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('print ;', 0, 8);
insert into PROPOSITION(enonceProposition, estBonne, idQuestion) values ('Les deux instructions sont équivalentes.', 0, 8);